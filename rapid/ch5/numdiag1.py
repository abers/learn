...
class NumberFormatDlg(QDialog):
    def __init__(self, format, parent=None):
        ...
        self.redNegativesCheckBox = QCheckBox("&Red negative nmbers")
        self.redNegativesCheckBox.setCheckable(format["rednegatives"])
        ...
        try:
            if len(decimal) == 0:
                raise DecimalError("The decimal marker may not be "
                                   "empty.")
            if len(thousands) > 1:
                raise ThousandsError("The thousands separtor may "
